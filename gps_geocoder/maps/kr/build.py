...
logger = logging.getLogger("gps_geocoder.maps.kr.build")
...
DB_FILE = MAPS_DIR / "south-korea.db"
PBF_FILE = MAPS_DIR / "south-korea-latest.osm.pbf"
GEOFABRIK_URL = "https://download.geofabrik.de/asia/south-korea-latest.osm.pbf"

# South Korea: 4=province/metro city, 6=city/county, 7=district, 8=dong/ri
